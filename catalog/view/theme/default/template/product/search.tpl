...
<div class="container" id="product-search">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <h2 class="white"><?php echo $text_search; ?></h2>
      <?php if ($products) { ?>
      <div class="row" id="search-filter">
        
        <div class="col-md-4 col-xs-6">
          <div class="form-group input-group input-group-sm">
            <label class="input-group-addon black" for="input-sort"><?php echo $text_sort; ?></label>
        ...
        <div class="col-md-3 col-xs-6">
          <div class="form-group input-group input-group-sm">
            <label class="input-group-addon black" for="input-limit"><?php echo $text_limit; ?></label>
          ...
          <div class="product-thumb transition home-products">
            ...
            <div class="button-group">
              ...
              <div class="cart-add-button" onclick="cart.add('<?php echo $product['product_id']; ?>');">
                <div class="green-button"><p>KØB</p></div>
              </div>
            </div>
      ...
      <?php } else { ?>
      <p class="white"><?php echo $text_empty; ?></p>
      <?php } ?>
