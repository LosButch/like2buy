...
<div id="product" class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> background-white content-padding"><?php echo $content_top; ?>
      <div class="row">
        <?php if ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-6'; ?>
        <?php } else { ?>
        ...
        <div class="col-sm-6">
		  ...
		  <ul class="thumbnails">
		    <?php if ($thumb) { ?>
			<li class="large-preview">
			<a class="thumbnail" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img width="300px" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
			</li>
		    <?php } ?>
		    <?php if ($images) { ?>
			<?php $image_count = count($images); ?>
			<?php for($i = 0; $i < $image_count; $i++) { ?>
				<?php $image = array_pop($images); ?>
	   ...
	   <?php } ?>
		...
		<h1 id="product-heading"><?php echo $heading_title; ?></h1>
		  ...
		  <div class="col-sm-8" id="top-content-block">
          <?php if ($price) { ?>
